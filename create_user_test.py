...
# Función de prueba negativa  ""PRUEBAS NEGATIVAS""
...
def test_create_user_1_letter_in_first_name_get_error_response():
    ...
    #Prueba 4. El parametro "firstname" tiene 16 characters
def test_create_user_16_letter_in_first_name_get_error_response():
    negative_assert_symbol("Aaaaaaaaaaaaaaaa")
    #Prueba 5 El parametro "firstname" no permite espacios
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Aa aaaa")
    #Prueba 6 EL parametro "firstname" no permite caracteres especiales
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("\"№%@\",")
    # Prueba 7 El parametro "firstname" contiene strings de numeros
    negative_assert_symbol("1,2,4")

#Creando la funcion para ejercicios 8 y 9
# La respuesta contiene el siguiente mensaje de error: "No se han enviado todos los\\
